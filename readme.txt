...
**1. Install & Activate**
- Upload the plugin files to the `/wp-content/plugins/pos-terminals-integration-for-stripe` directory, or install the plugin through the WordPress plugins screen directly.
...
You need an active Stripe account with Terminal access, a supported Stripe card reader, and an SSL certificate for your WordPress site (required for live payments).

= Does this work with WooCommerce? =

Yes! The plugin automatically creates WooCommerce orders when payments are completed, so all your sales are tracked in your store.
...
* Smart product search and cart management
* 4-step visual payment progress tracking
* Automatic Stripe Terminal reader discovery
